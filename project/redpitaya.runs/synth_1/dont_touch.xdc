...
# IP: ip/asg_dat_fifo/asg_dat_fifo.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==asg_dat_fifo || ORIG_REF_NAME==asg_dat_fifo} -quiet] -quiet

# IP: ip/sync_fifo/sync_fifo.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==sync_fifo || ORIG_REF_NAME==sync_fifo} -quiet] -quiet
